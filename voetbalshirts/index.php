...
// Query uitvoeren naar de juiste tabel (bijvoorbeeld 'review' in plaats van 'reviews')
$result = $mysqli->query("SELECT * FROM voetbalshirts");

// Controleren of de query succesvol was
if (!$result) {
    die("Queryfout: " . $mysqli->error);
}

// Gegevens verwerken
while ($row = $result->fetch_assoc()) {
    echo "ID: " . $row['id'] . " - Inhoud: " . $row['inhoud'] . "<br>";
}
